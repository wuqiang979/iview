<template>
  <div class="movie-list-wrap">
    <div class="search-filter-wrap">
      ...
      <div class="search-box">
        <Form ref="formData" :model="formData" :label-width="80" inline>
          <FormItem label="视频名称：" >
            <Input type="text" style="width:200px" clearable v-model="formData.name" placeholder="蛮三刀"/>
          </FormItem>
          <FormItem label="视频分类：">
    ...
    <div class="table-box">
      <h3 class="h3-title">
        <span>数据列表</span>
        <Button type="primary" @click="$router.push('/layout/upload?type=0')">+添加视频</Button>
      </h3>
      <VTable
        :columns="columns"
        :data="tableData"
        ...
        <div slot="action" slot-scope="props">
          <Button type="primary" style="margin-right: 5px" @click="$router.push({path: '/layout/modifyVideo',query:{id:props.data.row.id}})">编辑</Button>
